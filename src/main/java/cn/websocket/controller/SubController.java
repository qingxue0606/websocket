...
import cn.websocket.receive.ReceiveMessage;
@Controller
public class SubController {
     ...
     public void subscribe(ReceiveMessage rm) {
         for(int i =1;i<=20;i++) {
             ...
             System.out.println("subscribe"+rm.getName());
             //用/subscribe 接收 转到 /topic/getResponse
     ...
     public void queuw(ReceiveMessage rm) {
         ...
         for(int i =1;i<=20;i++) {
             ...
             System.out.println("queue"+rm.getName());
